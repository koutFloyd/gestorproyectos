...
class ProyectosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create proyecto" do
    assert_difference("Proyecto.count") do
      post proyectos_url, params: { proyecto: { desc: @proyecto.desc, estado: @proyecto.estado, fecha_i: @proyecto.fecha_i, fecha_t: @proyecto.fecha_t, name: @proyecto.name } }
    end
  ...
  test "should update proyecto" do
    patch proyecto_url(@proyecto), params: { proyecto: { desc: @proyecto.desc, estado: @proyecto.estado, fecha_i: @proyecto.fecha_i, fecha_t: @proyecto.fecha_t, name: @proyecto.name } }
